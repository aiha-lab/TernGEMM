...
void gemm_xor_avx_big(const int8_t* lhs, const int8_t* rhs, int8_t* dst,
    ...
    int64_t depth1 = (int64_t)(depth_last - 1) / 4;
    int64_t depth2 = (int64_t)(depth_last - 1) % 4 + 1;
    int64_t depth3 = (int64_t)(depth_last_2nd - 1) / 4;
    int64_t depth4 = (int64_t)(depth_last_2nd - 1) % 4 + 1;
...
void gemm_xor_avx_small(const int8_t* lhs, const int8_t* rhs, int8_t* dst,
    ...
    int64_t depth1 = (int64_t)(depth - 1) / 4;
    int64_t depth2 = (int64_t)(depth - 1) % 4 + 1;
    ...
    for (int i = 0; i < (width - 1) / 96; i++) {
        ...
        for (int j = 0; j < height; j++) {
            loop6(lhs + depth * j, rhs_m, dst_temp, depth1, depth2);
