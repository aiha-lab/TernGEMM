#ifndef GEMMLOWP_XOR_COMMON_1X96_H
#define GEMMLOWP_XOR_COMMON_1X96_H
...
inline void dst_init_1x96(int32_t* dst) {
...
inline void dst_add_1x96(int32_t* dst, int32_t* dst_temp) {
...
#endif //GEMMLOWP_XOR_COMMON_1X96_H
