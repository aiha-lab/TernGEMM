#ifndef GEMMLOWP_XOR_COMMON_1X128_H
#define GEMMLOWP_XOR_COMMON_1X128_H
...
inline void dst_init_1x128(int32_t *dst) {
...
inline void dst_add_1x128(int32_t *dst, int32_t *dst_temp) {
...
#endif //GEMMLOWP_XOR_COMMON_1X128_H
