#ifndef GEMMLOWP_XOR_COMMON_4x32_H
#define GEMMLOWP_XOR_COMMON_4x32_H
...
inline void dst_init_4x32(int32_t *dst) {
...
inline void dst_add_4x32(int32_t *dst, int32_t *dst_temp) {
...
#endif //GEMMLOWP_XOR_COMMON_4x32_H
